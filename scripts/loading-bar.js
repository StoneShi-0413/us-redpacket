...
(function() {
    ...
    angular.module('cfp.loadingBar', [])
        .provider('cfpLoadingBar', function() {
            ...
            this.spinnerTemplate = '<div id="waitingWrapper"> <div class="spinner-icon" ><div class="wrap" ><i class="icon-spin icon-cog" > </i> <i class="icon-spin icon-spin-reverse icon-cog" > </i> <i class = "icon-spin icon-cog" > </i> </div> </div></div>';
